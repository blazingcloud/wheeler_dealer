describe('Step3.Models.Game', function() {
  var game;
  beforeEach(function() {
    game = Step3.Models.Game.build();
  });
  ...
  describe('#init', function() {
    ...
    it('builds stacks', function() {
      expect(game.deck instanceof Step3.Models.Stack).toBe(true);
      expect(game.tableau instanceof Step3.Models.Stack).toBe(true);
      expect(game.waste instanceof Step3.Models.Stack).toBe(true);
    });
